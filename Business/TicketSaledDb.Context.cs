...
namespace Business
{
    ...
    public partial class TicketingEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetAtTheDoorSummary_Result> GetAtTheDoorSummary()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAtTheDoorSummary_Result>("GetAtTheDoorSummary");
        }
    }
}
